...
Nonetheless, at the moment since the viewer will always have a field of view less than $\pi$ in the software's intended usage, the tearing of the lens map could be hidden from the user.
